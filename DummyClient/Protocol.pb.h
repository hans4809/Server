...
// uint32 mp = 3;
inline void S_TEST::clear_mp() {
  mp_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 S_TEST::_internal_mp() const {
  return mp_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 S_TEST::mp() const {
  // @@protoc_insertion_point(field_get:Protocol.S_TEST.mp)
  return _internal_mp();
}
inline void S_TEST::_internal_set_mp(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  mp_ = value;
}
inline void S_TEST::set_mp(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_mp(value);
  // @@protoc_insertion_point(field_set:Protocol.S_TEST.mp)
}
