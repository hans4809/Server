...
bool DBConnection::BindColumn(int32 columnIndex, bool* value, SQLLEN* index)
{
	return BindColumn(columnIndex, SQL_C_TINYINT, size32(bool), value, index);
}

bool DBConnection::BindColumn(int32 columnIndex, float* value, SQLLEN* index)
{
	return BindColumn(columnIndex, SQL_C_FLOAT, size32(float), value, index);
}

bool DBConnection::BindColumn(int32 columnIndex, double* value, SQLLEN* index)
{
	return BindColumn(columnIndex, SQL_C_DOUBLE, size32(double), value, index);
}

bool DBConnection::BindColumn(int32 columnIndex, int8* value, SQLLEN* index)
{
	return BindColumn(columnIndex, SQL_C_TINYINT, size32(int8), value, index);
}

bool DBConnection::BindColumn(int32 columnIndex, int16* value, SQLLEN* index)
{
	return BindColumn(columnIndex, SQL_C_SHORT, size32(int16), value, index);
}

bool DBConnection::BindColumn(int32 columnIndex, int32* value, SQLLEN* index)
{
	return BindColumn(columnIndex, SQL_C_LONG, size32(int32), value, index);
}

bool DBConnection::BindColumn(int32 columnIndex, int64* value, SQLLEN* index)
{
	return BindColumn(columnIndex, SQL_C_SBIGINT, size32(int64), value, index);
}

bool DBConnection::BindColumn(int32 columnIndex, TIMESTAMP_STRUCT* value, SQLLEN* index)
{
	return BindColumn(columnIndex, SQL_C_TYPE_TIMESTAMP, size32(TIMESTAMP_STRUCT), value, index);
}
...
{
	return BindColumn(columnIndex, SQL_C_BINARY, size, bin, index);
}
