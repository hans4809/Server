...
namespace SP
{
	...
	public:
		...
		void Out_ObjectId(OUT int32& value) { BindColumn(0, value); }
		template<int32 N> void Out_TableName(OUT WCHAR(&value)[N]) { BindColumn(1, value); }
		template<int32 N> void Out_ColumnName(OUT WCHAR(&value)[N]) { BindColumn(2, value); }
		void Out_ColumnId(OUT int32& value) { BindColumn(3, value); }
		void Out_UserType(OUT int32& value) { BindColumn(4, value); }
		void Out_MaxLength(OUT int32& value) { BindColumn(5, value); }
		void Out_IsNullable(OUT bool& value) { BindColumn(6, value); }
		void Out_IsIdentity(OUT bool& value) { BindColumn(7, value); }
		void Out_SeedValue(OUT int64& value) { BindColumn(8, value); }
		void Out_IncrementValue(OUT int64& value) { BindColumn(9, value); }
		void Out_DefaultObjectId(OUT int32& value) { BindColumn(10, value); }
		template<int32 N> void Out_DefaultDefinition(OUT WCHAR(&value)[N]) { BindColumn(11, value); }
		template<int32 N> void Out_DefaultConstraintName(OUT WCHAR(&value)[N]) { BindColumn(12, value); }
	};
	...
	public:
		...
		void Out_ObjectId(OUT int32& value) { BindColumn(0, value); }
		template<int32 N> void Out_IndexName(OUT WCHAR(&value)[N]) { BindColumn(1, value); }
		void Out_IndexId(OUT int32& value) { BindColumn(2, value); }
		void Out_IndexType(OUT int32& value) { BindColumn(3, value); }
		void Out_IsPrimaryKey(OUT bool& value) { BindColumn(4, value); }
		void Out_IsUniqueConstraint(OUT bool& value) { BindColumn(5, value); }
		void Out_ColumnId(OUT int32& value) { BindColumn(6, value); }
		template<int32 N> void Out_ColumnName(OUT WCHAR(&value)[N]) { BindColumn(7, value); }
	};
	...
	public:
		...
		template<int32 N> void Out_Name(OUT WCHAR(&value)[N]) { BindColumn(0, value); }
		void Out_Body(OUT WCHAR* value, int32 len) { BindColumn(1, value, len); }
	};
}
