...
public:
	...
	bool BindColumn(int32 columnIndex, bool* value, SQLLEN* index);
	bool BindColumn(int32 columnIndex, float* value, SQLLEN* index);
	bool BindColumn(int32 columnIndex, double* value, SQLLEN* index);
	bool BindColumn(int32 columnIndex, int8* value, SQLLEN* index);
	bool BindColumn(int32 columnIndex, int16* value, SQLLEN* index);
	bool BindColumn(int32 columnIndex, int32* value, SQLLEN* index);
